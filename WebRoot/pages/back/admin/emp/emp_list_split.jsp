...
<script type="text/javascript" src="js/back/emp/emp_list_split.js"></script>
<style type="text/css">
tr:hover {
...
<%
	String url = "pages/back/admin/emp/emp_list_split.jsp";
	String keyWord = null;
	String column = "";
...
<body>
	...
	<%
		Map<String, Object> map = ServiceFactory.getIEmpServiceInstance()
				.list(column, keyWord, currentPage, lineSize);
